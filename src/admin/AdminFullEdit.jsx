                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="d-flex justify-content-between">
                            {news.status === "published" && (
                                <>
                                    <button type="button" className="btn btn-info" onClick={handleSavePublished}>
                            ...
                            {news.status === "inProgress" && (
                                <>
                                    ...
                                    <button type="button" className="btn btn-success" onClick={() => { onSubmit(watch(), "published") }}>
